...
export const CFG = {
  ...
  /* телефон: при завантаженні фігура займає весь вільний простір, а зі скролом відходить, меншає
     і зсувається ліворуч, звільняючи місце проєкції — рух закінчується ще до появи написів */
  pull: [0.02, 0.26],
...
export function getFrame(p, introT, cfg = CFG) {
  ...
  return {
    ...
    pull: smooth(cfg.pull[0], cfg.pull[1], ps),
